      ...
      <div className="grid min-h-screen lg:grid-cols-[1.02fr_0.98fr]">
        <div className="relative hidden overflow-hidden lg:block">
          ...
          <div className="relative flex h-full flex-col justify-between p-12">
            <div>
              <BrandLogo to="/" title="BentoBox" subtitle="Admin access" theme="light" size="lg" />
        ...
        <div className="flex items-center justify-center px-4 py-10 sm:px-6 lg:px-12">
          <div className="w-full max-w-md">
            <BrandLogo to="/" title="BentoBox" subtitle="Admin portal" theme="light" className="mb-8 lg:hidden" />
            <Outlet />
          </div>
        </div>
      </div>
